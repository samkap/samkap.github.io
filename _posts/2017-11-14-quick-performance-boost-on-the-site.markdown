...
![Google PageSpeed when I started, showing two suggestions](/img/posts/desktop-01-start.png)
{: .full}
...
![Google PageSpeed when I started, showing what was optimized ](/img/posts/desktop-02-start.png)
{: .full}
...
![webpagetest-start.png](/img/posts/webpagetest-start.png)
{: .full}
...
![typekit-01.png](/img/posts/typekit-01.png)
{: .full}
...
![typekit-02.png](/img/posts/typekit-02.png)
{: .full}
...
![Google PageSpeed Results](/img/posts/desktop-01-end.png)
{: .full}
...
![webpagetest results which went from 1.487s to 1.168s, fully loaded](/img/posts/webpagetest-end.png)
{: .full}
